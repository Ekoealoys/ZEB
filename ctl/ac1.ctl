Window and cooling control, sp 26.5 and 27.0
* Building
Zone cooling for ambient temp above 27 degC
   1  # No. of functions
* Control function    1
...
# actuates air point of the current zone
    ...
    0   19   0.000  # ctl type, law (senses ambient dry bulb temperature.), start @
     13.  # No. of data items
  0.000 0.000 5000.000 0.000 0.000 26.500 1.000 -3.000 0.000 0.000 0.000 0.000 27.000
# Function:Zone links
...
# actuates flow component:   4 op_win_xlrge
   -4    4    1  # actuator data
    ...
    1  365  # valid Mon-01-Jan - Mon-31-Dec
     1  # No. of periods in day: weekdays    
    0    0   0.000  # ctl type (outside ambient > flow), law (on/off setpoint 26.50 inverse action ON fraction 1.000.), starting @
      3.  # No. of data items
  26.50000 -1.00000 1.00000
